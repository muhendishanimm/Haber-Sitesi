	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form action="UyeGiris_Islem.jsp" class="login100-form validate-form" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate="Password is required">
					    <input class="input100" type="password" name="UyeSifre" >
						<span class="focus-input100"></span>
					...
					<div class="flex-sb-m w-full p-t-3 p-b-32">
						...
						<div>
							<a href="UyeSifremiUnuttum.jsp" class="txt1">
								Şifrenizi mi unuttunuz?      
							</a>&nbsp;&nbsp;&nbsp;&nbsp;
							<a href="UyeKayitOl.jsp" class="txt1">
								Uye değil misiniz? Hemen Kayıt Olun!
							</a>
						</div>
					</div>
