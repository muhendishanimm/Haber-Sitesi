...
<body>
 <div id="tabs">
        ...
        <div class="container"> 
        <div><br><br></div>
              <form action="YazarAra.jsp" method="post" >
<select id="YzrID" style="width: 200px; height: 30px;">  	    
   	<% 

	ResultSet rsk=sayiCrud.yazarselectAllData();
  	while(rsk.next()) 
  	{ %> 
  <option  value="<%=rsk.getString("AdSoyad")%>"  ><%=rsk.getString("AdSoyad")%></option>
  	<% } %>
</select>
<input type="hidden" class="form-control" id="yzr" name="yzr"  />
...
$("#yzr").val(deger);
  ...
  <% 
  ResultSet rs=sayiCrud.yazarselectAllData();
  while(rs.next()) { %>
  <tr>
